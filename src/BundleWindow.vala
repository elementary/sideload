...
public class Sideload.BundleWindow : Gtk.ApplicationWindow {
    public FlatpakBundleFile file { get; construct; }
    ...
    public BundleWindow (Gtk.Application application, FlatpakBundleFile file) {
        Object (
